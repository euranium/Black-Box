...
file.write("plot 'contourBase.dat' with image, 'contourLines.dat' w l, \"< paste meanTraitOneValues_ModelOne.txt meanTraitTwoValues_ModelOne.txt\" using 2:4 with lines lw 2 lt 4\n")
file.close();
